        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div ref={rightRef} className="sr-r hidden lg:block">
            <div ref={photoRef} className="rounded-2xl overflow-hidden" style={{ height: 540, position: 'relative' }}>
              <img src="https://images.unsplash.com/photo-1528605248644-14dd04022da1?auto=format&fit=crop&w=900&q=80" alt="Conference audience" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
