    ...
    >
      <div className="flex items-center gap-2.5 overflow-hidden">
        ...
        <p className="font-mono text-[11px] uppercase tracking-[.18em] whitespace-nowrap overflow-hidden text-ellipsis" style={{ color: '#F0EEF8' }}>
          Limited Passes Available &nbsp;&middot;&nbsp;
          <button
            onClick={onGoPasses}
    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50" style={{ background: '#05040C' }}>
        ...
        <nav
          ...
          style={scrolled
            ? { background: '#05040C', borderBottom: '1px solid rgba(28,26,50,0.8)' }
            : { background: '#05040C' }}
        >
      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex flex-col" style={{ background: '#05040C' }}>
          <div className="flex items-center justify-between px-6 h-16 border-b" style={{ borderColor: '#1C1A32' }}>
            <img src="/gpf-logo-v2.webp" alt="The Great Product Festival" style={{ height: 44, width: 'auto', maxWidth: '160px' }} />
