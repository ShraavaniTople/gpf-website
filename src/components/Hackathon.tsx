...
const format = [
  ...
  { n: '02', title: 'Team Composition', desc: 'Cross-functional squads of 2 to 4 members: product, design, and engineering in one team.' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div ref={rightRef} className="sr-r space-y-4">
            ...
            <div ref={photoRef} className="rounded-2xl overflow-hidden" style={{ height: 200, position: 'relative' }}>
