          ...
          <div className="flex items-start gap-10 flex-shrink-0 flex-wrap">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-6" style={{ height: 36 }}>
                <div style={{ width: 120, height: 36, display: 'flex', alignItems: 'center' }}>
                  <img src="/logos/elevenlabs-crop.png" alt="ElevenLabs" style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }} />
                </div>
                <div style={{ width: 120, height: 36, display: 'flex', alignItems: 'center' }}>
                  <img src="/logos/dodopayments.png" alt="Dodo Payments" style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }} />
                </div>
              </div>
            </div>
          </div>
