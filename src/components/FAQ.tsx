...
const faqs = [
  {
    ...
    a: 'The Great Product Fest is scheduled for Q3 2026 in Bangalore, India. Venue and exact dates will be announced to all registered pass holders well in advance.',
  },
  {
