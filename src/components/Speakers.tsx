      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div ref={headRef} className="sr mb-14">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <p className="text-base max-w-sm leading-relaxed lg:text-right" style={{ color: '#6B7280' }}>
              Elevate Your Voice. Share your expertise with a high-intent audience of product leaders and practitioners.
            </p>
          </div>
        </div>
