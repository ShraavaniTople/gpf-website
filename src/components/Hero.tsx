...
export default function Hero({ onSponsor, onCommunity }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden" style={{ background: '#05040C' }}>
      {/* Banner image at natural aspect ratio — no zoom, no stretch */}
      <img src={heroBanner} alt="" aria-hidden
        className="absolute z-0"
        style={{ width: '100%', height: 'auto', top: '50%', left: 0, transform: 'translateY(-50%)', display: 'block' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-24 md:pt-36 pb-12 flex items-center" style={{ minHeight: 'calc(100vw / 2.4)' }}>
