        ...
        <td style="border-radius:16px;overflow:hidden;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#16112B;border-radius:16px;overflow:hidden;">
            ...
            <tr>
              ...
              <td valign="top" width="70%" style="padding:22px 24px 22px 24px;border-right:2px dashed #3D3B55;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:16px;">
                  <tr>
                    <td width="3" height="24" style="background:#ffffff;margin-right:2px;"></td><td width="2" height="24" style="background:transparent;"></td>
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    await resend.emails.send({
      ...
      subject: `${to_name.split(' ')[0]}, share your TGPF 2026 Pass 🎉`,
